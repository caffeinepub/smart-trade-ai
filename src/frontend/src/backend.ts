...
import type { AnalysisRequest as _AnalysisRequest, AnalysisWithImageRequest as _AnalysisWithImageRequest, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async approveStrategy(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.approveStrategy(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async clearAnalysisHistory(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearAnalysisHistory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteCustomStrategy(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteCustomStrategy(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async generateCustomStrategy(arg0: string): Promise<CustomStrategy> {
        if (this.processError) {
            try {
                const result = await this.actor.generateCustomStrategy(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getApprovedStrategies(): Promise<Array<CommunityStrategy>> {
        if (this.processError) {
            try {
                const result = await this.actor.getApprovedStrategies();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCustomStrategies(): Promise<Array<CustomStrategy>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCustomStrategies();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPendingStrategies(): Promise<Array<CommunityStrategy>> {
        if (this.processError) {
            try {
    ...
    async rejectStrategy(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.rejectStrategy(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async requestAIAnalysis(arg0: AnalysisRequest): Promise<AnalysisResult> {
        if (this.processError) {
            try {
                const result = await this.actor.requestAIAnalysis(to_candid_AnalysisRequest_n6(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async requestAIAnalysisWithImage(arg0: AnalysisWithImageRequest): Promise<AnalysisResult> {
        if (this.processError) {
            try {
                const result = await this.actor.requestAIAnalysisWithImage(to_candid_AnalysisWithImageRequest_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async rotateGeminiKey(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.rotateGeminiKey();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setAccessToken(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setAccessToken(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async voteOnStrategy(arg0: string, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.voteOnStrategy(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function to_candid_AnalysisRequest_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: AnalysisRequest): _AnalysisRequest {
    return to_candid_record_n7(_uploadFile, _downloadFile, value);
}
function to_candid_AnalysisWithImageRequest_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: AnalysisWithImageRequest): _AnalysisWithImageRequest {
